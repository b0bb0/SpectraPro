...
interface RecentScan {
  id: string; status: string; scanLevel: string
    ...
    <div className="p-6 lg:p-8 space-y-8">
      ...
      <div className="cosmic-panel p-6" style={{ animation: 'rise 0.65s ease-out both' }}>
        <div className="mb-6 flex items-center justify-between">
          ...
          <button onClick={() => router.push('/dashboard/vulnerabilities')} className="text-sm font-medium" style={{ color: '#f0b840' }}>View All →</button>
        </div>
                ...
                <div className="flex items-start space-x-4 flex-1">
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="text-sm font-medium mb-1 line-clamp-1" style={{ color: '#e0d6f6' }}>
                      {vuln.cveId ? `${vuln.cveId} — ` : ''}{vuln.title}
                    </h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 cosmic-panel p-6" style={{ animation: 'rise 0.7s ease-out both' }}>
          <div className="mb-6 flex items-center justify-between">
            ...
            <button onClick={() => router.push('/dashboard/scans')} className="text-sm font-medium" style={{ color: '#f0b840' }}>View All →</button>
          </div>
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between mb-1">
                      <p className="text-sm font-medium truncate" style={{ color: '#e0d6f6' }}>{scan.asset?.name || 'Unknown'}</p>
                      <span
                    ...
                    <div className="flex items-center space-x-3 text-xs" style={{ color: '#6b5f8a' }}>
                      <span className="flex items-center space-x-1"><Target className="w-3 h-3" /><span>{scan.scanLevel}</span></span>
