...
export default function ScanDetailsPage({ params }: { params: { id: string } }) {
  ...
  useEffect(() => {
    ...
    // Reduced polling since WebSocket provides real-time updates
    // Only poll as backup every 30 seconds for completed scans
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-gray-400">
              Target: {scan.asset?.hostname || scan.asset?.ipAddress || scan.asset?.name}
            </p>
          </div>
        </div>
