...
export default function AssetsPage() {
  ...
  return (
    <div className="p-6 lg:p-8 space-y-8">
      ...
      {/* Error State */}
      {error && (
        <div className="glass-panel border-l-4 border-red-500 p-4 flex items-start gap-3" role="alert" aria-live="polite">
              ...
              <table className="w-full">
                <thead className="border-b border-border">
                  <tr>
                    ...
                    <th scope="col" className="px-6 py-4 text-right text-xs font-medium text-text-secondary uppercase tracking-wider">
                      Actions
                    </th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-border">
                  {assets.map((asset) => (
                    <tr
                      ...
                      onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); handleAssetClick(asset.id) }}}
                      tabIndex={0}
