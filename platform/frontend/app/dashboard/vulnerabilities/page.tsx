    ...
    <div className="p-6 lg:p-8 space-y-6">
      ...
      <div className="glass-panel p-6">
        ...
        {loading ? (
          ...
          <div className="space-y-3" role="list" aria-label="Vulnerability list">
            {vulnerabilities.map((vuln) => (
              <div
                ...
                onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); router.push(`/dashboard/vulnerabilities/${vuln.id}?returnTo=${encodeURIComponent('/dashboard/vulnerabilities')}`) }}}
                tabIndex={0}
        ...
        >
          <div className="glass-panel p-6 max-w-md w-full">
            <div className="flex items-center justify-between mb-6">
              <h2 id="save-filter-title" className="text-2xl font-bold text-white">Save Filter Preset</h2>
              <button
