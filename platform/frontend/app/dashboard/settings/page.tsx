            ...
            <>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input type="password" placeholder="Enter Shodan API key..." className="input-field font-mono text-sm" />
                </div>
                <div>
                  <label className="block text-sm font-medium mb-1.5" style={{ color: '#8878a9' }}>VirusTotal API Key</label>
                  <input type="password" placeholder="Enter VirusTotal API key..." className="input-field font-mono text-sm" />
                </div>
