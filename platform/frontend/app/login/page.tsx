      ...
      <div className="relative z-10 w-full max-w-md px-6">
        ...
        <div className="glass p-8 rounded-2xl shadow-card animate-scale-in">
          <form onSubmit={handleSubmit} className="space-y-6">
            {/* Error Message */}
            {error && (
              <div className="flex items-start space-x-3 p-4 bg-red-500/10 border border-red-500/20 rounded-lg text-red-400 text-sm" role="alert" aria-live="polite">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center space-x-2 cursor-pointer">
                <input
                  type="checkbox"
                  className="w-4 h-4 rounded border-border bg-background-elevated text-primary focus:ring-2 focus:ring-primary/50"
                />
          ...
          {process.env.NODE_ENV === 'development' && (
            <div className="mt-6 p-4 bg-primary/5 border border-primary/10 rounded-lg">
              ...
              <div className="text-xs text-text-secondary space-y-1">
                <p><span className="text-text-muted">Email:</span> admin@demo.com</p>
                <p><span className="text-text-muted">Password:</span> admin123</p>
              </div>
            </div>
          )}
