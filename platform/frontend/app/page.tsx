  ...
  return (
    <div className="min-h-screen relative overflow-hidden" style={{ background: 'var(--color-bg)' }}>
      ...
      <a
        ...
        style={{ background: 'var(--color-gold)', color: '#02020d' }}
      >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-8 pb-24">
        ...
        >
          <Link href="/" className="flex items-center gap-3 group" aria-label="SpectraPRO home">
            <div
              className="h-11 w-11 rounded-xl flex items-center justify-center transition-shadow"
              style={{
                background: 'linear-gradient(135deg, #f0b840, #9d5fff)',
                boxShadow: '0 0 20px rgba(240, 184, 64, 0.3)',
              }}
            >
              <Shield className="w-5 h-5" style={{ color: '#02020d' }} aria-hidden="true" />
            </div>
            <div>
          ...
          <nav className="flex items-center gap-3" aria-label="Main navigation">
            ...
            <Link href="/register" className="btn-premium inline-flex items-center gap-2 text-sm">
        ...
        <main id="main-content">
          <section className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch mt-6" aria-labelledby="hero-heading">
            {/* Main hero card */}
            <div
            ...
            >
              ...
              <h1
                id="hero-heading"
                className="mt-7 text-3xl sm:text-4xl lg:text-[3.4rem] leading-[1.08] font-bold"
                style={{ color: '#e0d6f6' }}
              >
                Offensive{' '}
              ...
              <div className="mt-8 flex flex-wrap items-center gap-3">
                <Link href="/login" className="btn-premium inline-flex items-center gap-2">
                  Enter Workspace <ArrowRight className="w-4 h-4" aria-hidden="true" />
                </Link>
                <Link
                  href="/register"
                  className="px-5 py-3 rounded-lg text-sm font-medium transition-all hover:bg-white/5 inline-flex items-center gap-2"
                  style={{
              ...
              {/* Stats */}
              <div className="mt-10 grid grid-cols-1 sm:grid-cols-3 gap-3 text-sm" role="list" aria-label="Platform statistics">
                {[
              ...
              >
                <div className="flex items-center justify-between mb-5">
                  <div>
                    ...
                    <p id="pulse-heading" className="text-lg font-semibold" style={{ color: '#e0d6f6' }}>
                      Executive snapshot
                    </p>
                  </div>
                  <span
                ...
                <div className="mt-4 flex items-center gap-2 text-sm" style={{ color: '#8878a9' }}>
                  <Workflow className="w-4 h-4" style={{ color: '#9d5fff' }} aria-hidden="true" />
              ...
              >
                <div className="flex items-center justify-between mb-5">
                  <div>
                    ...
                    <p id="flow-heading" className="text-lg font-semibold" style={{ color: '#e0d6f6' }}>
                ...
                <ol className="space-y-2" aria-label="Scanning pipeline steps">
          ...
          <section
            className="mt-16"
            style={{ animation: 'rise 0.65s ease-out both' }}
          ...
          >
            <div className="mb-8">
              ...
              <h2 id="features-heading" className="text-3xl font-bold" style={{ color: '#e0d6f6' }}>
          ...
          >
            <div className="cosmic-panel p-10 sm:p-14 relative overflow-hidden">
              <div
              ...
              <div className="relative">
                <Lock className="w-8 h-8 mx-auto mb-4" style={{ color: '#f0b840' }} aria-hidden="true" />
                <h2 id="cta-heading" className="text-3xl sm:text-4xl font-bold mb-3" style={{ color: '#e0d6f6' }}>
                  Ready to <span className="gradient-text">take command</span>?
                </h2>
                <p className="text-base sm:text-lg max-w-xl mx-auto mb-8" style={{ color: '#8878a9' }}>
                ...
                <div className="flex items-center justify-center gap-4 flex-wrap">
                  <Link href="/login" className="btn-premium inline-flex items-center gap-2 text-base px-8 py-3.5">
                    Launch Platform <ArrowRight className="w-5 h-5" aria-hidden="true" />
                  </Link>
                  <Link
                    href="/register"
        ...
        {/* Footer */}
        <footer role="contentinfo" className="mt-16 border-t pt-10 pb-4" style={{ borderColor: 'rgba(157,95,255,0.1)' }}>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
            {/* Brand */}
            <div>
              <div className="flex items-center gap-2 mb-3">
                <Shield className="w-5 h-5" style={{ color: '#f0b840' }} aria-hidden="true" />
                <span className="font-semibold font-mono" style={{ color: '#e0d6f6' }}>SpectraPRO</span>
              </div>
              <p className="text-sm leading-relaxed" style={{ color: '#6b5f8a' }}>
                Offensive security command platform for modern vulnerability management programs.
              </p>
            </div>

            {/* Product */}
            <div>
              <p className="text-xs uppercase tracking-[0.12em] font-mono mb-3" style={{ color: '#f0b840' }}>Product</p>
            ...
            {/* Resources */}
            <div>
              <p className="text-xs uppercase tracking-[0.12em] font-mono mb-3" style={{ color: '#f0b840' }}>Resources</p>
              <ul className="space-y-2">
            ...
            {/* Legal */}
            <div>
              <p className="text-xs uppercase tracking-[0.12em] font-mono mb-3" style={{ color: '#f0b840' }}>Legal</p>
              <ul className="space-y-2">
          ...
          <div
            className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-6 border-t text-sm"
            style={{ borderColor: 'rgba(157,95,255,0.08)', color: '#6b5f8a' }}
          >
            <p>&copy; {new Date().getFullYear()} SpectraPRO. All rights reserved.</p>
            <p className="font-mono text-xs">Offensive Security Command Platform</p>
          </div>
        </footer>
      </div>
    </div>
